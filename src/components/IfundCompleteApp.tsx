...
/**
 * IFUND EQUITY — Complete production preview app
 * Live market board + brand portal + Step 1 pricing + US Places autocomplete
 */
      ...
      <header className="sticky top-0 z-20 border-b border-brand-navy/10 bg-brand-white/95 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <span className="hidden font-sans text-sm text-brand-slate sm:inline">
              Step 1 of 1
            </span>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 font-sans text-xs text-brand-slate">
                Enter the full street address so pricing can reflect local
                eligibility and investor overlays.
              </p>
            </div>
          ...
          {pricingResults.length > 0 && (
            <div className="mt-10 border-t border-brand-navy/10 pt-6">
              ...
              <p className="mb-4 font-sans text-sm text-brand-slate">
                Tailored to your scenario and shown in context with the live
                market board above.
              </p>
